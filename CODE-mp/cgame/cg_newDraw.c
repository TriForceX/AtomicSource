...
void CG_MouseEvent(int x, int y) {
	...
	if ( (cg.predictedPlayerState.pm_type == PM_NORMAL || (cg.predictedPlayerState.eFlags & EF_JETPACK) || cg.predictedPlayerState.pm_type == PM_FLOAT || cg.predictedPlayerState.pm_type == PM_SPECTATOR) && cg.showScores == qfalse) {
